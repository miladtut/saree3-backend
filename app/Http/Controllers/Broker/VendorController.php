...
class VendorController extends Controller
{
    ...
    {
        return view('broker-views.vendor.index');
    }
    ...
    public function store(Request $request)
    {
        ...
        $vendor->broker_id = Helpers::get_broker_id ();
        $vendor->status = null;
        $vendor->save();
        ...
        return redirect()->route ('broker.vendor.list');
    }
    ...
    public function list(Request $request)
    {
        ...
        return view('broker-views.vendor.list', compact('stores', 'zone','type'));
    }
    ...
    public function search(Request $request){
        ...
        return response()->json([
            'view'=>view('broker-views.vendor.partials._table',compact('stores'))->render(), 'total'=>$total
        ]);
    }
