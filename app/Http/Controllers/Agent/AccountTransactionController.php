...
class AccountTransactionController extends Controller
{
    ...
    {
        $account_transaction = AccountTransaction::where('agent_id',Helpers::get_agent_id ())->latest()->paginate(config('default_pagination'));
        return view('agent-views.account.index', compact('account_transaction'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $account_transaction->agent_id = Helpers::get_agent_id ();
        ...
        try
        {
            ...
            AgentWallet::where('agent_id', Helpers::get_agent_id ())->increment('collected_cash', $request['amount']);
            DB::commit();
        }
        catch(\Exception $e)
        {
    ...
    public function show($id)
    {
        ...
        return view('agent-views.account.view', compact('account_transaction'));
    }
