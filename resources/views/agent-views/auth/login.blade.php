                ...
                <div class="card card-lg mb-5">
                    <div class="card-body">
                        <div class="text-center">
                            <div class="mb-5">
                                <h1 class="display-4">{{translate('messages.agent')}} {{translate('messages.sign_in')}}</h1>
                        ...
                        <!-- Form -->
                        <form class="login_form" action="{{route('agent.auth.login')}}" method="post" id="vendor_login_form">
                            @csrf
                            <!-- Form Group -->
                            <div class="text-center">
                                <div class="m-2">
                                    <span class="divider text-muted m-4">{{translate('messages.agent_login_form')}}</span>
                                </div>
                            </div>
                    ...
                    @if(env('APP_MODE')=='demo')
                        <div class="card-footer">
                            <div class="row">
                                <div class="col-10">
                                    <span class="badge badge-soft-info">Agent login credential.</span><br>
                                    <span>Email : test.agent@gmail.com</span><br>
