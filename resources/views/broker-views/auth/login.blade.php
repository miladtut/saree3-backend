                ...
                <div class="card card-lg mb-5">
                    <div class="card-body">
                        <div class="text-center">
                            <div class="mb-5">
                                <h1 class="display-4">{{translate('messages.broker')}} {{translate('messages.sign_in')}}</h1>
                        ...
                        <!-- Form -->
                        <form class="login_form" action="{{route('broker.auth.login')}}" method="post" id="vendor_login_form">
                            @csrf
                            <!-- Form Group -->
                            <div class="text-center">
                                <div class="m-2">
                                    <span class="divider text-muted m-4">{{translate('messages.broker_login_form')}}</span>
                                </div>
                            </div>
